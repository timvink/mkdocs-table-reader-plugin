...
def setup_clean_mkdocs_folder(mkdocs_yml_path, output_path):
    ...
    shutil.copytree(os.path.join(os.path.dirname(mkdocs_yml_path),"docs"), testproject_path / "docs")
    shutil.copytree(os.path.join(os.path.dirname(mkdocs_yml_path),"assets"), testproject_path / "assets")
...
def test_table_output(tmp_path):
    ...
    tmp_proj = setup_clean_mkdocs_folder("tests/fixtures/basic_setup/mkdocs.yml", tmp_path)
...
def test_compatibility_markdownextradata(tmp_path):
    ...
    tmp_proj = setup_clean_mkdocs_folder("tests/fixtures/markdownextradata/mkdocs.yml", tmp_path)
